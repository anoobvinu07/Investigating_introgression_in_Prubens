...
echo eigen 1
echo 0#########################################0
pcangsd --beagle ${beagle}/red_spruce_fam324_angsd@0.933.beagle.gz -o ${WD}/kinship_matrix/pcangsd/red_spruce_fam324_eigen1_MAF0.1 --threads 24 --sites-save --dosage-save --pi-save --maf 0.1 --maf-save --iter 100000 -e 1
