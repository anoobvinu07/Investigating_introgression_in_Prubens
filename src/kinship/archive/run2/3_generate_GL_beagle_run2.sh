...
#SBATCH --job-name=QPC_angsd_run2
...
count=`cat ${WD}/REGIONS/324RSfam_bam_VACC.list | wc -l`

angsd -b ${WD}/REGIONS/324RSfam_bam_VACC.list \
-ref ${ref}/Pmariana1.0-genome_reduced.fa \
-anc ${ref}/Pmariana1.0-genome_reduced.fa \
-fai ${ref}/Pmariana1.0-genome_reduced.fa.fai \
-out ./minMAF_filtering/Full_Sampling_minMAF_filtering_run2_MAF0.1_July2025 \
-sites ./REGIONS/intersect_run2.txt \
-nThreads 8 \
-uniqueOnly 1 \
-remove_bads 1 \
-trim 1 \
