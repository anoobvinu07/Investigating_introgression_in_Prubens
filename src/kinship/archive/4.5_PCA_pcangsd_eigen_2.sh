...
echo eigen 2
echo 0#########################################0
pcangsd --beagle ${beagle}/red_spruce_fam324_angsd@0.933.beagle.gz -o ${WD}/kinship_matrix/pcangsd/red_spruce_fam324_eigen2 --threads 24 --sites-save --dosage-save --pi-save --iter 100000 -e 2 